...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_pure_css_loader_dist_css_loader_css__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_pure_css_loader_dist_css_loader_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_pure_css_loader_dist_css_loader_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery_modal_jquery_modal_min_css__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery_modal_jquery_modal_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery_modal_jquery_modal_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sass_checkConversation_scss__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sass_checkConversation_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__sass_checkConversation_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery_modal_jquery_modal_min_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery_modal_jquery_modal_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_jquery_modal_jquery_modal_min_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__settings_settings_js__ = __webpack_require__(0);
...
(async function () {
  let cfg = await Object(__WEBPACK_IMPORTED_MODULE_4__settings_settings_js__["a" /* getSettingsAsync */])();
  ...
  replies.each((index, item) => {
    ...
    $(item).find('.reply_content').prev().before(`<a href="javascript:;" id="checkConversationBtn">
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../._css-loader@0.28.7@css-loader/index.js!./css-loader.css", function() {
			var newContent = require("!!../../._css-loader@0.28.7@css-loader/index.js!./css-loader.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../._css-loader@0.28.7@css-loader/index.js!./jquery.modal.min.css", function() {
			var newContent = require("!!../._css-loader@0.28.7@css-loader/index.js!./jquery.modal.min.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/._css-loader@0.28.7@css-loader/index.js!../../../../node_modules/._sass-loader@6.0.6@sass-loader/lib/loader.js!./checkConversation.scss", function() {
			var newContent = require("!!../../../../node_modules/._css-loader@0.28.7@css-loader/index.js!../../../../node_modules/._sass-loader@6.0.6@sass-loader/lib/loader.js!./checkConversation.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "@charset \"UTF-8\";\n/* www.v2ex.com/t/ */\n/* 对话详情 */\n#checkConversationBtn {\n  padding-left: 10px;\n  color: #ccc;\n  font-size: 12px; }\n  #checkConversationBtn:hover {\n    opacity: .7; }\n  #checkConversationBtn > i {\n    padding-right: 4px; }\n\n#conversationModal.modal {\n  max-width: 800px;\n  padding: 10px;\n  line-height: 1.6 !important;\n  word-break: break-all;\n  word-wrap: break-word; }\n  #conversationModal.modal > .cell {\n    overflow: hidden; }\n    #conversationModal.modal > .cell > .left {\n      float: left; }\n      #conversationModal.modal > .cell > .left img {\n        border-radius: 4px; }\n    #conversationModal.modal > .cell > .right {\n      margin-left: 60px; }\n      #conversationModal.modal > .cell > .right > .author {\n        color: gray;\n        margin-bottom: 10px; }\n", ""]);
